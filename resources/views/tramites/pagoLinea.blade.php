            ...
            <div id="grid-container-pagoLinea">
                <div>
                    <picture tabindex="0">
                        ...
                        <img loading="lazy" src="{{ asset('images/tramites/pago_linea/pago_linea_1.webp') }}" id="consultaLiquidacionImg"
            ...
            <div id="grid-container-pagoLinea">
                <div>
                    <picture tabindex="0">
                        ...
                        <img loading="lazy" src="{{ asset('images/tramites/pago_linea/pago_linea_2.webp') }}" id="consultaLiquidacionImg"
                            alt="Cunsulta Liquidación" class="img-responsive" />
                    </picture>
                </div>
                <div class="textPR">
            ...
            <div id="grid-container-pagoLinea">
                <div>
                    <picture tabindex="0">
                        ...
                        <img loading="lazy" src="{{ asset('images/tramites/pago_linea/pago_linea_3.webp') }}" id="consultaLiquidacionImg"
                            alt="Cunsulta Liquidación" class="img-responsive" />
                    </picture>
                </div>
                <div class="textPR">
            ...
            <div id="grid-container-pagoLinea">
                <div id="botonPSEImg">
                    <picture tabindex="0">
                        ...
                        <img loading="lazy" src="{{ asset('images/tramites/pago_linea/BotonPSE.webp') }}" id="botonPSE"
                            alt="Cunsulta Liquidación" class="img-responsive" />
                    </picture>
                </div>
                <div class="textPR">
