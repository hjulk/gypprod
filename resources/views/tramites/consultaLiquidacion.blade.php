                        ...
                        <div class="col-md-12" id="pageImage">
                            <a href="https://cmovilgyp.com/wliquidacion/" target="_blank">
                                    ...
                                    @foreach($ConsultaImg as $imagesCL)
                                        @if(strpos($imagesCL->UBICACION, '.jpg') !== false)
                                            <picture tabindex="0">
                                                ...
                                                <img loading="lazy" src="{{ asset(str_replace('../', '/', $imagesCL->UBICACION_WEBP)) }}" id="consultaLiquidacionImg" alt="Consulta Liquidación" class="img-responsive"/>                                                
                                            </picture>
                                        @else
                                            <picture tabindex="0">
                                                <source srcset="{{ asset(str_replace('../', '/', $imagesCL->UBICACION_WEBP)) }}" type="image/webp"/>
                                ...
                                {{-- <picture>
                                    ...
                                    <img loading="lazy" src="{{asset("images/tramites/consulta_liquidacion/consulta_liquidacion.webp") }}" id="consultaLiquidacionImg" alt="Cunsulta Liquidación" class="img-responsive"/>
                                </picture> --}}
                            </a>
                        </div>
                    </div>
