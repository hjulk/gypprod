                    ...
                    <div class="row">
                        <div class="col-md-6" id="logoPass" >
                            <picture>
                                ...
                                <img loading="lazy" src="{{asset("images/password.webp") }}" alt="Login" class="user-image"/>
                            </picture>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
            ...
            <div class="container" id="imageModal">
                ...
                <center>
                    <picture>
                        ...
                        <img loading="lazy" src="{{asset("images/check.webp")}}" id="imgAlerts">
                    </picture>
                </center>
            </div>
            <div class="modal-body">
            ...
            <div class="container" id="imageModal">
                ...
                <center>
                    <picture>
                        ...
                        <img loading="lazy" src="{{asset("images/uncheck.webp")}}" id="imgAlerts">
                    </picture>
                </center>
            </div>
            <div class="modal-body">
