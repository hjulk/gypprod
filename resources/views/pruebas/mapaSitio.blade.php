            ...
            <div class="row">
              <div class="col-lg-12 ml-auto" data-aos="fade-up" data-aos-delay="200">
                <div class="bg-white p-3 p-md-5">
                  <div class="row">
                    <a href="{{ url('pruebas/') }}"><h4 class="text-black mb-4" id="tituloMapaSitio">INICIO</h4></a>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                    <ul>
                      ...
                      <li> <a href="{{asset("images/gyp/organigrama/Organigrama.pdf")}}" target="_blank" title="Organigrama" id="linkMapaSitio">Organigrama</a></li>
                  ...
                  <div class="row">
                    <ul>
                      ...
                      <li style="font-size: medium;font-weight: 700;" tabindex="0"> Peticiones, quejas y reclamos
                        <ul>
                          <li><a href="https://bogota.gov.co/sdqs/crear-peticion" id="linkMapaSitio" target="_blank">Registrar su PQRS</a></li>
                          <li><a href="https://bogota.gov.co/sdqs/consultar-peticion" id="linkMapaSitio" target="_blank">Consulte su PQRS en Bogotá te Escucha</a></li>
                        </ul>
                      </li>
                  ...
                  <div class="row">
                    <ul>
                      ...
                      <li> <a href="servicios/procesoInmovilizacion" id="linkMapaSitio">Proceso Inmovilización</a></li>
                  ...
                  <div class="row">
                    <a href="trabajo"><h4 class="text-black mb-4" id="tituloMapaSitio" tabindex="0">TRABAJE CON NOSOTROS</h4></a>
                  </div>
                </div>
              </div>
            </div>
