        ...
        <div class="row">
            <div class="col-md-5">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="tel:6019279254"><span class="icon icon-phone"></span>&nbsp;(601) 9279254</a> - <a href="tel:+5719279254">3124985077</a></li>
            ...
            <div class="col-md-3">
                ...
                <ul class="list-unstyled">
                    <li><a href="{{url('pruebas/nosotros')}}">Nosotros</a></li>
                    <li><a href="pruebas/servicios/nuestrosServicios">Servicios</a></li>
                    <li><a href="pruebasservicios/tarifas">Tarifas</a></li>
                    <li><a href="{{url('pruebas/normatividad')}}">Normatividad</a></li>
                    <li><a href="{{url('pruebas/puntosAtencion')}}">Puntos de Atención</a></li>
                    <li><a href="{{url('pruebas/contacto')}}">Contáctenos</a></li>
                    @if($PoliticaHSEQ)
                        {!! $PoliticaHSEQ !!}
                    @endif
                    <li><a href="{{url('pruebas/mapaSitio')}}">Mapa del Sitio</a></li>
                </ul>
            </div>
            <div class="col-md-4" id="titulo1footer">
                {{-- <img src="{{asset("images/footer-black.png")}}" alt="" id=footerImg> --}}
                <picture tabindex="0">
