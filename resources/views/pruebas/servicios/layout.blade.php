...
<!-- Global site tag (gtag.js) - Google Analytics -->
	...
	<script>
	  ...
	  gtag('config', 'G-G5RS7NZJQG');
        ...
        <link rel="preload" href="{{asset("css/stylePruebas.css")}}" as="style" onload="this.onload=null;this.rel='stylesheet'">
        <noscript><link rel="stylesheet" href="{{asset("css/stylePruebas.css")}}"></noscript>
        @yield("styles")
    </head>
    <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
        ...
        <div class="site-wrap" id="home-section">
            @include("pruebas.servicios.topBar")
            @include("pruebas.servicios.menu")
            <div class="ftco-blocks-cover-1">
                @yield("barraInformacion")
                <br>
                @yield("contenido")
            </div>
            @include("pruebas.servicios.footer")
            ...
            <script src="{{asset("js/subpaginaPruebas.js")}}"></script>
