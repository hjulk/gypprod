...
@section('contenido')
            ...
            <div class="row">
                <div class="col-md-12">
                    <p id="resolucionGruas" tabindex="0">
                        ...
                        remolcar otro vehículo". Para el particular esta carrocería está diseñada para llevar cierta cantidad de
    ...
    <section class="ftco-section" id="sectionPage">
        <div class="container">
            <div class="row align-items-center" id="franjaTituloPagina" tabindex="0">
                <div class="col-lg-12">
                    <h3 id="tituloSubPaginaHome" tabindex="0">Tipos de grúa con los que cuenta el consecionario</h2>
                </div>
            </div>
            <br>
        </div>
    ...
    <section class="ftco-section" id="sectionGruas">
        <div class="container" id="containerGruas">
            <div class="row">
                <div class="col-md-12" style="align-self: center;">
                    <h4 class="text-primary" id="subTitleGruas" tabindex="0">Grúas de planchón para motocicletas</h4><br>
                    <p id="contentGruas" tabindex="0">
