<header class="site-navbar js-sticky-header site-navbar-target" role="banner">
    <div class="container">
        <div class="row align-items-center position-relative">
            <div class="col-12">
                <a href="../../pruebas" tabindex="0">
                    {{-- <script src="{{asset("js/logoPruebaServicios.js")}}"></script> --}}
                    {{-- <picture tabindex="0">
                ...
                <nav class="site-navigation text-right ml-auto " role="navigation">
                    <ul class="site-menu main-menu js-clone-nav ml-auto d-none d-lg-block">
                        <li id="liMenu"><a href="../../pruebas" class="nav-link" id="linkHome">Inicio</a></li>
                        ...
                        <li id="liMenu"><a href="../trabajo" class="nav-link" id="linkHome">Trabaje con Nosotros</a></li>
                    </ul>
                </nav>
            </div>
