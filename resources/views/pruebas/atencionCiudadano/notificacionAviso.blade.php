        ...
        <div class="container">
            <div class="row mb-5">
                <div class="block-heading-1 col-12 text-center">
                    <h3 id="tituloNotificacion" tabindex="0">Notificación por aviso</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="mb-5">
                        <p id="textnotificacion" tabindex="0">
                        ...
                        <p id="textnotificacion" tabindex="0">Una vez surtida la comunicación a los ciudadanos
            ...
            <div class="row">
                <div class="col-md-12">
                    <table id="notificaciones" class="display table-striped responsive no-wrap">
                        <thead>
                            <td tabindex="0">NOMBRE DEL CIUDADANO</td>
                            <td tabindex="0">PLACA DEL VEH&Iacute;CULO</td>
                            <td tabindex="0">A&Ntilde;O REPORTE DE LA RECLAMACI&Oacute;N</td>
                        </thead>
                        <tbody>
                            @foreach ($Notificaciones as $value)
                                <tr>
                                    <td tabindex="0">{{$value['NOMBRE']}}</td>
                                    <td tabindex="0">{{$value['PLACA']}}</td>
                                    <td tabindex="0">{{$value['YEAR']}}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
