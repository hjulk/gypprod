...
@section('contenido')
    <section class="site-section bg-light" id="contact-section">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 id="titlePreguntaFrecuente">Si el vehículo inmovilizado debe salir del patio en grúa ¿Qué documentos debo tener en cuenta en el momento de contratar este servicio con un tercero o particular?</h2>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-md-12">
                    <p id="preguntaFrecuenteText">
                        Si el vehículo debe salir del patio en grúa por orden de la Autoridad de Tránsito, tenga en cuenta los siguientes documentos y su vigencia, en el momento de contratar el servicio con un tercero o particular:<br>
                        <ul>
                            <li>Seguro Obligatorio de Accidentes de Tránsito – SOAT</li><br>
                            <li>Revisión Técnico – mecánica</li><br>
                            <li>Póliza de seguro contra daños a terceros</li><br>
