...
@section('contenido')
    <section class="site-section bg-light" id="contact-section">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 id="titlePreguntaFrecuente">¿Qué normatividad establece los valores de cobro de las tarifas de patios (Parqueadero Autorizado No. 01)?</h2>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-md-12">
                    <p id="preguntaFrecuenteText">De acuerdo con la Resolución 172 de 2019, por medio de la cual se modifica la resolución 062 de 2018, se establecen las tarifas para los servicios de grúas y parqueaderos de inmovilización de vehículos.</p>
                </div>
            </div>
            <br>
            <div class="row">
