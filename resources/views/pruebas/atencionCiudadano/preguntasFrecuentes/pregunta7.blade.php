...
@section('contenido')
    <section class="site-section bg-light" id="contact-section">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 id="titlePreguntaFrecuente">¿Cómo es el proceso para la recepción del vehículo en las instalaciones del patio (Parqueadero Autorizado No. 01)?</h2>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-md-12">
                    <p id="preguntaFrecuenteText">Una vez el vehículo inmovilizado llega al patio <b>(Parqueadero Autorizado No. 01)</b>, se entrega al personal de la concesión que se encuentran este lugar, quienes realizan un video e inventario y lo ubican en el lugar donde permanecerá hasta la reclamación por parte de la persona autorizada.</p>
                </div>
            </div>
            <br>
            <div class="row">
