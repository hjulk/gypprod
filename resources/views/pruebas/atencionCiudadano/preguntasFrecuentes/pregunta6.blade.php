...
@section('contenido')
    <section class="site-section bg-light" id="contact-section">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 id="titlePreguntaFrecuente">¿Cómo se le informa al propietario que su vehículo fue inmovilizado por mal parqueo o abandono en la vía?</h2>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-md-12">
                    <p id="preguntaFrecuenteText">La Concesión GYP envía al propietario registrado en el RUNT, un mensaje de texto informando la inmovilización del vehículo.</p>
                </div>
            </div>
            <br>
            <div class="row">
