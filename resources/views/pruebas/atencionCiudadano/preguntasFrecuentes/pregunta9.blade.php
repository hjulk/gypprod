...
@section('contenido')
    <section class="site-section bg-light" id="contact-section">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 id="titlePreguntaFrecuente">¿Dónde se puede realizar el trámite de salida del vehículo inmovilizado?</h2>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-md-12">
                    <p id="preguntaFrecuenteText">Para realizar el trámite de salida de patios la ciudadanía debe agendar una cita para la atención en <a href="https://www.movilidadbogota.gov.co" target="_blank" class="linkPregunta"><b>www.movilidadbogota.gov.co</b></a> o en el Centro de Contacto de Movilidad (601) 3649400 opción 2.</p>
                </div>
            </div>
            <br>
            <div class="row">
