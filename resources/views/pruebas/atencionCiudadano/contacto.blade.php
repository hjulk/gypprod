        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 mb-5" data-aos-delay="100">
                    {!! Form::open(['url' => 'contacto', 'method' => 'get', 'enctype' => 'multipart/form-data','autocomplete'=>'off','id'=>'form-contacto']) !!}
                    @csrf
                ...
                <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="200">
                    <div class="bg-white p-3 p-md-5">
                        ...
                        <ul class="list-unstyled footer-link">
                            ...
                            <li class="d-block mb-3" id="infoContact" tabindex="0"><span class="d-block text-black">Teléfono:</span><span>+57(1) 9279254</span>
                            </li>
                            <li class="d-block mb-3" id="infoContact" tabindex="0"><span class="d-block text-black">Correo:</span><span><a
