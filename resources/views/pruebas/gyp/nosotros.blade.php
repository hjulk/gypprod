...
@section('contenido')
        ...
        <div class="container">
            <div class="row" id="pageImage">
                <div class="col-md-12">
                    @handheld
                        <picture tabindex="0">
                            <source srcset="{{asset("images/gyp/nosotros/logo_nosotros_movil.webp") }}" type="image/webp"/>
                            <source srcset="{{asset("images/gyp/nosotros/logo_nosotros_movil.png") }}" type="image/png"/>
                            <img src="{{asset("images/gyp/nosotros/logo_nosotros_movil.webp") }}" alt="Inicio" id="imagenPagina" class="bannerPasosRetiro"/>
                        </picture>
                    @elsehandheld
                        <picture tabindex="0">
                            <source srcset="{{asset("images/gyp/nosotros/logo_nosotros_nuevo.webp") }}" type="image/webp"/>
                            <source srcset="{{asset("images/gyp/nosotros/logo_nosotros_nuevo.png") }}" type="image/png"/>
                            <img src="{{asset("images/gyp/nosotros/logo_nosotros_nuevo.webp") }}" alt="Inicio" id="imagenPagina" class="bannerPasosRetiro"/>
                        </picture>
                    @endhandheld
                </div>
            </div>
    ...
    <section class="site-section" id="sectionPage">
        <div class="container">
            <div class="row align-items-center" id="franjaTituloPagina">
                <div class="col-lg-12">
                    <h3 id="tituloSubPaginaHome">Principios</h2>
                </div>
            </div>
            <br>
            {{-- <script src="{{asset("js/nosotrosPruebas.js")}}"></script> --}}
            ...
            {{-- <div class="row" id="pageImage">
                <div class="col-md-12">
                    <picture tabindex="0">
                        <source srcset="{{asset("images/gyp/nosotros/principios.webp") }}" type="image/webp"/>
                        <source srcset="{{asset("images/gyp/nosotros/principios.png") }}" type="image/png"/>
                        <img src="{{asset("images/gyp/nosotros/principios.webp") }}" id="logoNosotros" alt="Principios" class="nosotros-logo"/>
                    </picture>
                </div>
            </div> --}}
            {{-- <div class="row" id="pageImage">
          ...
          {{-- <div class="row">
            <div class="col-md-4">
                <picture tabindex="0">
                    ...
                    <img src="{{asset("images/gyp/nosotros/nosotros_foto_1.webp") }}" id="logoNosotros" alt="Nosotros" class="nosotros-logo"/>
                </picture>
            </div>
            <div class="col-md-4">
                <picture tabindex="0">
                    ...
                    <img src="{{asset("images/gyp/nosotros/nosotros_foto_2.webp") }}" id="logoNosotros" alt="Nosotros" class="nosotros-logo"/>
                </picture>
            </div>
            <div class="col-md-4">
                <picture tabindex="0">
                    ...
                    <img src="{{asset("images/gyp/nosotros/nosotros_foto_3.webp") }}" id="logoNosotros" alt="Nosotros" class="nosotros-logo"/>
                </picture>
            </div>
          </div> --}}
