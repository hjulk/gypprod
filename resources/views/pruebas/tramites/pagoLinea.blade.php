...
<noscript><link rel="stylesheet" href="{{asset("css/pagoLinea.css")}}"></noscript>
@endsection
...
<section class="ftco-section" id="sectionPage">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <h3 id="titlesubServicios" tabindex="0">Para facilitar el trámite de tu vehículo inmovilizado, recuerda que
...
<section class="ftco-section" id="sectionPage">
        ...
        <div id="grid-container-pagoLinea">
            <div>
                <picture tabindex="0">
                    ...
                    <img src="{{asset("images/tramites/pago_linea/pago_linea_1.webp") }}" id="consultaLiquidacionImg" alt="Cunsulta Liquidación" class="img-responsive"/>
                </picture>
            </div>
            <div class="textPR">
                <p id="textPagoLinea" tabindex="0">
                    <span class="movilidad">1</span> Dirígete a la página <a href="https://www.movilidadbogota.gov.co" target="_blank">www.movilidadbogota.gov.co</a> y haz click en liquidación de servicios de parqueaderos y grúas
                </p>
            </div>
        </div>
        <div id="grid-container-pagoLinea">
            <div>
                <picture tabindex="0">
                    ...
                    <img src="{{asset("images/tramites/pago_linea/pago_linea_2.webp") }}" id="consultaLiquidacionImg" alt="Cunsulta Liquidación" class="img-responsive"/>
                </picture>
            </div>
            <div class="textPR">
                <p id="textPagoLinea" tabindex="0">
        ...
        <div id="grid-container-pagoLinea">
            <div>
                <picture tabindex="0">
                    ...
                    <img src="{{asset("images/tramites/pago_linea/pago_linea_3.webp") }}" id="consultaLiquidacionImg" alt="Cunsulta Liquidación" class="img-responsive"/>
                </picture>
            </div>
            <div class="textPR">
                <p id="textPagoLinea" tabindex="0">
        ...
        <div id="grid-container-pagoLinea">
            <div>
                <picture tabindex="0">
                    ...
                    <img src="{{asset("images/tramites/pago_linea/BotonPSE.webp") }}" id="botonPSE" alt="Cunsulta Liquidación" class="img-responsive"/>
                </picture>
                {{-- <img src="{{asset("images/botonPSE.png")}}" alt="pago en línea" id="iconoPago" tabindex="0"> --}}
            </div>
            <div class="textPR">
                <p id="textPagoLinea" tabindex="0">
    ...
    {{-- <section class="ftco-section" id="sectionPage">
        <div class="container">
            <h3 id="titlesubServiciosPL">Ciudadano.</h3>
            <h3 id="titlesubServicios">Para facilitar el trámite de tu vehículo inmovilizado, recuerda que
                puedes pagar en línea.</h3>
        </div>
    </section>
    <section class="ftco-section" id="sectionPage">
        <div class="container">
            <div class="row" id="infoPagoLinea">
                <div class="col-md-4">
                    <picture tabindex="0">
                        <source srcset="{{asset("images/tramites/pago_linea/pago_linea_1.webp") }}" type="image/webp"/>
                        <source srcset="{{asset("images/tramites/pago_linea/pago_linea_1.png") }}" type="image/png"/>
    ...
    <section class="ftco-section" id="sectionPage">
        <div class="container">
            <div class="row" id="infoPagoLinea">
                <div class="col-md-4">
                    <img src="{{asset("images/BotonPSE.png")}}" alt="pago en línea" id="iconoPago">
                </div>
                <div class="col-md 8">
                    <p id="textPagoLinea">
                        <span class="movilidad">4</span> Realiza el pago en línea fácil y rápido.
