                ...
                <div class="col-md-12">
                    @handheld
                        <picture tabindex="0">
                            ...
                            <img loading="lazy" src="images/gyp/nosotros/logo_nosotros_movil.webp" alt="Inicio" id="imagenPagina" class="bannerPasosRetiro"/>
                        </picture>
                    @elsehandheld
                        <picture tabindex="0">
                            ...
                            <img loading="lazy" src="images/gyp/nosotros/logo_nosotros_nuevo.webp" alt="Inicio" id="imagenPagina" class="bannerPasosRetiro"/>
                        </picture>
                    @endhandheld
                </div>
            </div>
            ...
            <div class="nosotros-gallery">
                <div>
                    <picture tabindex="0">
                        ...
                        <img loading="lazy" src="{{asset("images/gyp/nosotros/servicio_cliente.webp") }}" id="principios" alt="Nosotros" class="nosotros-logo"/>
                    </picture>
                </div>
                <div>
                    <picture tabindex="0">
                        ...
                        <img loading="lazy" src="{{asset("images/gyp/nosotros/trabajo_equipo.webp") }}" id="principios" alt="Nosotros" class="nosotros-logo"/>
                    </picture>
                </div>
                <div>
                    <picture tabindex="0">
                        ...
                        <img loading="lazy" src="{{asset("images/gyp/nosotros/seguridad.webp") }}" id="principios" alt="Nosotros" class="nosotros-logo"/>
                    </picture>
                </div>
                <div>
                    <picture tabindex="0">
                        ...
                        <img loading="lazy" src="{{asset("images/gyp/nosotros/responsabilidad.webp") }}" id="principios" alt="Nosotros" class="nosotros-logo"/>
                    </picture>
                </div>
                <div>
                    <picture tabindex="0">
                        ...
                        <img loading="lazy" src="{{asset("images/gyp/nosotros/puntualidad.webp") }}" id="principios" alt="Nosotros" class="nosotros-logo"/>
                    </picture>
                </div>
                <div>
                    <picture tabindex="0">
                        ...
                        <img loading="lazy" src="{{asset("images/gyp/nosotros/mejoramiento_continuo.webp") }}" id="principios" alt="Nosotros" class="nosotros-logo"/>
                    </picture>
                </div>
                <div>
                    <picture tabindex="0">
                        ...
                        <img loading="lazy" src="{{asset("images/gyp/nosotros/calidad_servicio.webp") }}" id="principios" alt="Nosotros" class="nosotros-logo"/>
                    </picture>
                </div>
            </div>
          <br>
            ...
            <div class="grid-container-infoInteres">
                    ...
                    @foreach($Nosotros as $imagesN)
                        @if(strpos($imagesN->UBICACION, '.jpg') !== false)
                            <picture tabindex="0">
                                ...
                                <img loading="lazy" src="{{ asset(str_replace('../', '/', $imagesN->UBICACION_WEBP)) }}" id="imgNosotros" alt="Nosotros"/>
                ...
                {{-- <div>
                    <picture tabindex="0">
                        ...
                        <img loading="lazy" src="{{asset("images/gyp/nosotros/nosotros_foto_1.webp") }}" id="imgNosotros" alt="Nosotros" class="nosotros-logo"/>
                    </picture>
                </div>
                <div>
                    <picture tabindex="0">
                        ...
                        <img loading="lazy" src="{{asset("images/gyp/nosotros/nosotros_foto_2.webp") }}" id="imgNosotros" alt="Nosotros" class="nosotros-logo"/>
                    </picture>
                </div>
                <div>
                    <picture tabindex="0">
                        ...
                        <img loading="lazy" src="{{asset("images/gyp/nosotros/nosotros_foto_3.webp") }}" id="imgNosotros" alt="Nosotros" class="nosotros-logo"/>
                    </picture>
                </div> --}}
            </div>
        </div>
