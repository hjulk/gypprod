                                    ...
                                    <a href="{{ $images->ENLACE }}" target="_blank">
                                        @if(strpos($images->UBICACION, '.jpg') !== false)
                                            <picture tabindex="0">
                                                ...
                                                <img loading="lazy" src="{{ asset(str_replace('../', '/', $images->UBICACION_WEBP)) }}" id="imagenPagina" alt="Banner" class="bannerHome mx-auto"/>
                                            </picture>
                                        @else
                                            <picture tabindex="0">
                                                <source srcset="{{ asset(str_replace('../', '/', $images->UBICACION_WEBP)) }}" type="image/webp"/>
                                    ...
                                    <a href="{{ $imagesB->ENLACE }}" target="_blank">
                                        @if(strpos($imagesB->UBICACION, '.jpg') !== false)
                                            <picture>
                                                ...
                                                <img loading="lazy" src="{{ asset(str_replace('../', '/', $imagesB->UBICACION_WEBP)) }}" id="imagenPagina" alt="Banner" class="bannerHome mx-auto"/>
                                            </picture>
                                        @else
                                            <picture>
                                                <source srcset="{{ asset(str_replace('../', '/', $imagesB->UBICACION_WEBP)) }}" type="image/webp"/>
                                            ...
                                            <a href="{{ $value->ENLACE }}" @if(strpos($value->ENLACE, 'videos') !== false) id="videoHomeLink" @else target="_blank" @endif>
                                                @if(strpos($value->UBICACION, '.jpg') !== false)
                                                    <picture>
                                                        ...
                                                        <img loading="lazy" src="{{ asset(str_replace('../', '/', $value->UBICACION_WEBP)) }}" id="imgCarruselGyp" alt="GYP 2023" class="d-block w-100"/>
                                                    </picture>
                                                @else
                                                    <picture>
                                                        <source srcset="{{ asset(str_replace('../', '/', $value->UBICACION_WEBP)) }}" type="image/webp"/>
                                            ...
                                            <a href="{{ $imagen->ENLACE }}" @if(strpos($imagen->ENLACE, 'videos') !== false) id="videoHomeLink" @else target="_blank" @endif>
                                                @if(strpos($imagen->UBICACION, '.jpg') !== false)
                                                    <picture>
                                                        ...
                                                        <img loading="lazy" src="{{ asset(str_replace('../', '/', $imagen->UBICACION_WEBP)) }}" id="imgCarruselGyp" alt="GYP 2023" class="d-block w-100"/>
                                                    </picture>
                                                @else
                                                    <picture>
                                                        <source srcset="{{ asset(str_replace('../', '/', $imagen->UBICACION_WEBP)) }}" type="image/webp"/>
                        ...
                        @foreach($ImageEndYear as $imagesEY)
                            @if(strpos($imagesEY->UBICACION, '.jpg') !== false)
                                <picture tabindex="0">
                                    ...
                                    <img loading="lazy" src="{{ asset(str_replace('../', '/', $imagesEY->UBICACION_WEBP)) }}" id="imagenServicios" alt="Fin de Año"/>
            ...
            <div class="row" id="ciudadanoRecuerda">
                <div class="col-md-2" id=imgCiudadanoRecuerda>
                    <picture tabindex="0">
                        ...
                        <img loading="lazy" src="{{ asset('images/home/icon_home.webp') }}" id="iconHome" alt="Inicio" />
                    </picture>
                </div>
                <div class="col-md-10">
                    ...
                    <div class="col-md-12">
                        <a href="{{ asset('documentos/Comunicado_prensa_septiembre_28_2023.pdf') }}" target="_blank" title="Aviso Prensa" onclick='return avisar()'>
                            <picture tabindex="0">
                                ...
                                <img loading="lazy" src="{{ asset('images/aviso.webp') }}" id="avisoPrensa" alt="Inicio" />
                            </picture>                        
                        </a>
                    </div>                
                </div>
                ...
                <div>
                    <a href="servicios/gruas">
                        <picture>
                            ...
                            <img loading="lazy" src="{{ asset('images/home/informacion_interes_1.webp') }}" id="imagenServicios"
                                alt="Grúas" />
                        </picture>
                    </a>
                </div>
                <div>
                    <a href="puntosAtencion">
                        <picture>
                            ...
                            <img loading="lazy" src="{{ asset('images/home/informacion_interes_2.webp') }}" id="imagenServicios"
                                alt="Puntos Atención" />
                        </picture>
                    </a>
                </div>
                <div>
                    <a href="servicios/procesoRetiro">
                        <picture>
                            ...
                            <img loading="lazy" src="{{ asset('images/home/informacion_interes_3.webp') }}" id="imagenServicios"
                                alt="Proceso Retiro" />
                        </picture>
                    </a>
                </div>
                <div>
                    <a href="servicios/monitoreoCamaras">
                        <picture>
                            ...
                            <img loading="lazy" src="{{ asset('images/home/informacion_interes_4.webp') }}" id="imagenServicios"
                        ...
                        @foreach ($TarifasSubsanacion as $tarifaDoc)
                            <a href=" {{ str_replace('../', '',$tarifaDoc->UBICACION) }}" target="_blank">
                                <picture>
                                    ...
                                    <img loading="lazy" src="{{ asset('images/home/informacion_interes_5.webp') }}" id="imagenServicios"
                ...
                <div>
                    <a href="pagoLinea">
                        <picture>
                            ...
                            <img loading="lazy" src="{{ asset('images/home/informacion_interes_6.webp') }}" id="imagenServicios"
                            ...
                            @foreach($Tarifas as $imagesT)
                                @if(strpos($imagesT->UBICACION, '.jpg') !== false)
                                    <picture tabindex="0">
                                        ...
                                        <img loading="lazy" src="{{ asset(str_replace('../', '/', $imagesT->UBICACION_WEBP)) }}" id="imagenServicios" alt="Nuestras Tarifas"/>
                                    </picture>
                                @else
                                    <picture tabindex="0">
                                        <source srcset="{{ asset(str_replace('../', '/', $imagesT->UBICACION_WEBP)) }}" type="image/webp"/>
                    ...
                    <p id="tarifasText" tabindex="0">
                        ...
                        <a href="servicios/tarifas" id="tarifasEnlace">
                            <picture>
                                ...
                                <img loading="lazy" src="{{ asset('images/home/boton_tarifas.webp') }}" alt="Nuestras Tarifas"
