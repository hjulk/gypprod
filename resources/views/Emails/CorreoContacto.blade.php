...
<div class="col-md-12">
    ...
    <h2 style="font-family:Verdana;font-size:14px;"><b>Buen día</b></h2>
        <br>
        <p style="font-family:Verdana;font-size:14px;">A continuación se detalla la información enviada desde el formulario Contáctenos de la página de Grúas y Parqueaderos Bogotá S.A.S</p>
        <br>
    <br>
...
<tr>
    <th colspan='2'><b>Contáctenos</b></th>
</tr>
<tr height='20px'></tr>
<tr>
...
<tr>
    <td style="text-transform: uppercase;"><b>Mensaje:</b></td>
    <td>{{ $Mensaje }}</td>
</tr>
