    ...
    <section class="ftco-section" id="sectionPage">
        <div class="container" id="imagePage">
            {{-- <picture>
                ...
                <img loading="lazy" src="{{asset("images/home/PENDON_RETIRAR_DEL_PATIO_ARTE_FINAL.webp") }}" id="imagenPagina" alt="Inicio"/>
            </picture>
            ...
            <picture>
                ...
                <img loading="lazy" src="{{asset("images/home/PQR_PENDON.webp") }}" id="imagenPagina" alt="pqrs"/>
            </picture>
            <p>Foto: GyP Bogotá S.A.S - Año: 2021</p>
        </div>
    </section>
