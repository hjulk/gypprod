                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12" id="imgCard">
                                        <a href="imagesBanner"><img loading="lazy" src="{{asset("images/seccion_banner.png") }}" alt=""></a>
                                    <br><br>
                                        <p>Banner</p>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12" id="imgCard">
                                        <a href="imagesBannerM"><img loading="lazy" src="{{asset("images/seccion_banner.png") }}" alt=""></a>
                                    <br><br>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12" id="imgCard">
                                        <a href="imagesCarousel"><img loading="lazy" src="{{asset("images/seccion_carrusel.png") }}" alt=""></a>
                                    <br><br>
                                        <p>Carrusel</p>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12" id="imgCard">
                                        <a href="imagesCarouselM"><img loading="lazy" src="{{asset("images/seccion_carrusel.png") }}" alt=""></a>
                                    <br><br>
