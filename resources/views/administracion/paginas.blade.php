                        ...
                        <div class="row">
                            <div class="col-md-12" id="imgCard">
                                <picture>
                                    ...
                                    <img loading="lazy" src="{{asset("images/pagina.webp") }}" id="imgCard" alt="Roles" class="img-responsive"/>
                                </picture>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="row">
                            <div class="col-md-12" id="imgCard">
                                <picture>
                                    ...
                                    <img loading="lazy" src="{{asset("images/subpagina.webp") }}" id="imgCard" alt="Roles" class="img-responsive"/>
                                </picture>
                            </div>
                        </div>
                        <br>
