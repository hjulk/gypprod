                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12" id="imgCard">
                                        <a href="imagesHomePage"><img loading="lazy" src="{{asset("images/pagina_inicio.png") }}" alt=""></a>
                                    <br><br>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12" id="imgCard">
                                        <a href="imagesUs"><img loading="lazy" src="{{asset("images/pagina_nosotros.png") }}" alt=""></a>
                                    <br><br>
                                        <p>Página Nosotros</p>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12" id="imgCard">
                                        <a href="imagesOrganigrama"><img loading="lazy" src="{{asset("images/pagina_organigrama.png") }}" alt=""></a>
                                    <br><br>
                                        <p>Organigrama</p>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12" id="imgCard">
                                        <a href="imagesSettlementConsultation"><img loading="lazy" src="{{asset("images/pagina_consulta_liquidacion.png") }}" alt=""></a>
                                    <br><br>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12" id="imgCard">
                                        <a href="imagesBenefits"><img loading="lazy" src="{{asset("images/pagina_beneficios.png") }}" alt=""></a>
                                    <br><br>
                                        <p>Beneficios</p>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12" id="imgCard">
                                        <a href="imagesTows"><img loading="lazy" src="{{asset("images/pagina_gruas.png") }}" alt=""></a>
                                    <br><br>
                                        <p>Grúas</p>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12" id="imgCard">
                                        <a href="imagesMonitoringCameras"><img loading="lazy" src="{{asset("images/pagina_monitoreo_camaras.png") }}" alt=""></a>
                                    <br><br>
