                        ...
                        <div class="row">
                            <div class="col-md-12" id="imgCard">
                                <picture>
                                    ...
                                    <img loading="lazy" src="{{asset("images/tipo_tarifa.webp") }}" id="imgCard" alt="Gruas" class="img-responsive"/>
                                </picture>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="row">
                            <div class="col-md-12" id="imgCard">
                                <picture>
                                    ...
                                    <img loading="lazy" src="{{asset("images/nombre_tarifa.webp") }}" id="imgCard" alt="Gruas" class="img-responsive"/>
                                </picture>
                            </div>
                        </div>
                        <br>
