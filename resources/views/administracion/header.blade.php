            ...
            <li class="dropdown user user-menu">
                <a href="index" class="dropdown-toggle" data-toggle="dropdown" id="enlace">
                    <picture>
                        ...
                        <img loading="lazy" src="{{asset("images/logo_admin.webp") }}" id="logoNosotros" alt="User Img" class="user-image"/>
                    </picture>
                    <span class="hidden-xs">{!! Session::get('NombreUsuario') !!}</span>
                </a>
                <ul class="dropdown-menu">
                    <li class="user-header">
                        <img loading="lazy" src="{{asset("images/logo_admin.png")}}" class="brand-image img-circle elevation-3" alt="User Image">
