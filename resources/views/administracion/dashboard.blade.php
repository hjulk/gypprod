                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12" id="imgCard">
                                        <img loading="lazy" src="{{asset("images/docs_menu.png") }}" alt="">
                                    <br><br>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12" id="imgCard">
                                        <img loading="lazy" src="{{asset("images/images_menu.png") }}" alt="">
                                    <br><br>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12" id="imgCard">
                                        <img loading="lazy" src="{{asset("images/preguntas_frecuentes.png") }}" alt="">
                                    <br><br>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12" id="imgCard">
                                        <img loading="lazy" src="{{asset("images/web_visit.png") }}" alt="">
                                    <br><br>
