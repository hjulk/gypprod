    ...
    <section class="ftco-section" id="sectionPage">
        <div class="container">
            <div id="pasosInmovilizacion1">
                <div>
                    <picture tabindex="0">
                        ...
                        <img loading="lazy" src="{{asset("images/servicios/proceso_inmovilizacion/proceso_inmovilizacion_1.webp")}}" id="procesoInmovilizacionImg" alt="Proceso Inmovilizacion" class="img-responsive"/>
                    </picture>
                </div>
                <div class="textPR">
            ...
            <div id="pasosInmovilizacion2" class="reverse">
                ...
                <div class="imgPR">
                    <picture tabindex="0">
                        ...
                        <img loading="lazy" src="{{asset("images/servicios/proceso_inmovilizacion/proceso_inmovilizacion_2.webp")}}" id="procesoInmovilizacionImg" alt="Proceso Inmovilizacion" class="img-responsive"/>
                    </picture>
                </div>
            </div>
            <div id="pasosInmovilizacion1">
                <div>
                    <picture tabindex="0">
                        ...
                        <img loading="lazy" src="{{asset("images/servicios/proceso_inmovilizacion/proceso_inmovilizacion_3.webp")}}" id="procesoInmovilizacionImg" alt="Proceso Inmovilizacion" class="img-responsive"/>
                    </picture>
                </div>
                <div class="textPR">
                    <p id="textProcesoInmovilizacion" tabindex="0">
            ...
            <div id="pasosInmovilizacion2" class="reverse">
                <div class="textPR">
                    <p id="textProcesoInmovilizacion" tabindex="0">
                        Se procede a realizar un cargue seguro del vehículo y se traslada al patio donde es ubicado según su tipología.
                    </p>
                </div>
                <div class="imgPR">
                    <picture tabindex="0">
                        ...
                        <img loading="lazy" src="{{asset("images/servicios/proceso_inmovilizacion/proceso_inmovilizacion_4.webp")}}" id="procesoInmovilizacionImg" alt="Proceso Inmovilizacion" class="img-responsive"/>
                    </picture>
                </div>
            </div>
        </div>
