                ...
                <div>
                    <picture tabindex="0">
                        ...
                        <source srcset="{{ asset('images/servicios/proceso_retiro/proceso_retiro_1.png') }}"
                            type="image/png" />
                        <img loading="lazy" src="{{ asset('images/servicios/proceso_retiro/proceso_retiro_1.webp') }}"
                ...
                <div class="imgPR">
                    <picture tabindex="0">
                        ...
                        <source srcset="{{ asset('images/servicios/proceso_retiro/proceso_retiro_2.png') }}"
                            type="image/png" />
                        <img loading="lazy" src="{{ asset('images/servicios/proceso_retiro/proceso_retiro_2.webp') }}"
                            id="procesoRetiroImg" alt="Proceso Retiro" class="img-responsive" />
                    </picture>
                </div>
            </div>
                ...
                <div>
                    <picture tabindex="0">
                        ...
                        <source srcset="{{ asset('images/servicios/proceso_retiro/proceso_retiro_3.png') }}"
                            type="image/png" />
                        <img loading="lazy" src="{{ asset('images/servicios/proceso_retiro/proceso_retiro_3.webp') }}"
                            id="procesoRetiroImg" alt="Proceso Retiro" class="img-responsive" />
                    </picture>
                </div>
                <div class="textPR">
                ...
                <div class="imgPR">
                    <picture tabindex="0">
                        ...
                        <source srcset="{{ asset('images/servicios/proceso_retiro/proceso_retiro_4.png') }}"
                            type="image/png" />
                        <img loading="lazy" src="{{ asset('images/servicios/proceso_retiro/proceso_retiro_4.webp') }}"
                            id="procesoRetiroImg" alt="Proceso Retiro" class="img-responsive" />
                    </picture>
                </div>
            </div>
                ...
                <div>
                    <picture tabindex="0">
                        ...
                        <source srcset="{{ asset('images/servicios/proceso_retiro/proceso_retiro_5.png') }}"
                            type="image/png" />
                        <img loading="lazy" src="{{ asset('images/servicios/proceso_retiro/proceso_retiro_5.webp') }}"
                            id="procesoRetiroImg" alt="Proceso Retiro" class="img-responsive" />
                    </picture>
                </div>
                <div class="textPR">
