                        ...
                        @if (strpos($images->UBICACION, '.jpg') !== false)
                            <div class="col-md-6" style="align-self: center;">
                                <picture tabindex="0">
                                    ...
                                    <img loading="lazy" src="{{ asset(str_replace('../', '', $images->UBICACION_WEBP)) }}" id="imagesGruas" alt="Gancho Extrapesado" />
                                </picture>
                                <br>
                        ...
                        @if (strpos($images->UBICACION, '.jpg') !== false)
                            <div class="col-md-6" style="align-self: center;">
                                <picture tabindex="0">
                                    <source srcset="{{ asset(str_replace('../', '', $images->UBICACION_WEBP)) }}" type="image/webp" />
                                    <source srcset="{{ asset(str_replace('../', '', $images->UBICACION)) }}" type="image/jpg" />
                                    <img loading="lazy" src="{{ asset(str_replace('../', '', $images->UBICACION_WEBP)) }}" id="imagesGruas" alt="Gancho Pesado" />
                                </picture>
                                <br>
                                <p id="footerImage">{!! $images->PIE_IMAGEN !!}</p>
                            </div>
                        ...
                        @if (strpos($images->UBICACION, '.jpg') !== false)
                            <div class="col-md-6" style="align-self: center;">
                                <picture tabindex="0">
                                    <source srcset="{{ asset(str_replace('../', '', $images->UBICACION_WEBP)) }}" type="image/webp" />
                                    <source srcset="{{ asset(str_replace('../', '', $images->UBICACION)) }}" type="image/jpg" />
                                    <img loading="lazy" src="{{ asset(str_replace('../', '', $images->UBICACION_WEBP)) }}" id="imagesGruas" alt="Gancho Planchon" />
                                </picture>
                                <br>
                                <p id="footerImage">{!! $images->PIE_IMAGEN !!}</p>
                            </div>
                        ...
                        @if (strpos($images->UBICACION, '.jpg') !== false)
                            <div class="col-md-6" style="align-self: center;">
                                <picture tabindex="0">
                                    <source srcset="{{ asset(str_replace('../', '', $images->UBICACION_WEBP)) }}" type="image/webp" />
                                    <source srcset="{{ asset(str_replace('../', '', $images->UBICACION)) }}" type="image/jpg" />
                                    <img loading="lazy" src="{{ asset(str_replace('../', '', $images->UBICACION_WEBP)) }}" id="imagesGruas"
