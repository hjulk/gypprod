            ...
            <div class="row" id="imagesBeneficios">
                <div class="col-md-12" id="pageImage">
                        ...
                        @foreach ($ImgMonitoreo as $images)
                            @if (strpos($images->UBICACION, '.jpg') !== false)                                
                                <picture tabindex="0">
                                    ...
                                    <img loading="lazy" src="{{ asset(str_replace('../', '/', $images->UBICACION_WEBP)) }}" id="imagenPagina" alt="Monitoreo con Cámaras"/>
                                </picture>
                                <br>
                    ...
                    {{-- <picture tabindex="0">
                        ...
                        <img loading="lazy" src="{{asset("images/servicios/monitoreo_camaras/monitoreo_camaras.webp") }}" id="imagenPagina" alt="Monitoreo con Cámaras">
                    </picture>
