...
@section('contenido')
    <section class="site-section" id="sectionPage">
        <div class="container">
            ...
            <div class="row" id="NuestrosServiciosDescripcion">
                <div class="col-md-4">
                    <a href="gruas"><img loading="lazy" src="{{asset("images/servicios/nuestros_servicios/gruas.png")}}" alt="grúas" id="imagenServicios"></a>
                </div>
                <div class="col-md-8">
    ...
    <section class="site-section" id="sectionPage">
        <div class="container">
            ...
            <div class="row" id="NuestrosServiciosDescripcion">
                <div class="col-md-4">
                    <a href="../puntosAtencion"><img loading="lazy" src="{{asset("images/servicios/nuestros_servicios/puntos_atencion.png")}}" alt="Puntos de atención" id="imagenServicios"></a>
                </div>
                <div class="col-md-8">
                    <p id="textNuestrosServicios">
    ...
    <section class="site-section" id="sectionPage">
        <div class="container">
            ...
            <div class="row" id="NuestrosServiciosDescripcion">
                <div class="col-md-4">
                    <a href="procesoRetiro"><img loading="lazy" src="{{asset("images/servicios/nuestros_servicios/retiro_vehiculo.png")}}" alt="Proceso de retiro" id="imagenServicios"></a>
                </div>
                <div class="col-md-8">
                    <p id="textNuestrosServicios">
    ...
    <section class="site-section" id="sectionPage">
        <div class="container">
            ...
            <div class="row" id="NuestrosServiciosDescripcion">
                <div class="col-md-4">
                    <a href="monitoreoCamaras"><img loading="lazy" src="{{asset("images/servicios/nuestros_servicios/monitoreo_camaras.png")}}" alt="Monitoreo con cámaras" id="imagenServicios"></a>
                </div>
                <div class="col-md-8">
                    <p id="textNuestrosServicios">
    ...
    <section class="site-section" id="sectionPage">
        <div class="container">
            ...
            <div class="row" id="NuestrosServiciosDescripcion">
                <div class="col-md-4">
                    <a href="mensajeSms"><img loading="lazy" src="{{asset("images/servicios/nuestros_servicios/mensaje_texto.png")}}" alt="Mensajes de texto" id="imagenServicios"></a>
                </div>
                <div class="col-md-8">
                    <p id="textNuestrosServicios">
    ...
    <section class="site-section" id="sectionPage">
        <div class="container">
            ...
            <div class="row" id="NuestrosServiciosDescripcion">
                <div class="col-md-4">
                    <a href="../pagoLinea"><img loading="lazy" src="{{asset("images/servicios/nuestros_servicios/pago_linea.png")}}" alt="Pagos en línea" id="imagenServicios"></a>
                </div>
                <div class="col-md-8">
                    <p id="textNuestrosServicios">
