...
class ImagenesController extends Controller
{
    ...
    public function CrearImagenBanner(Request $request){
        ...
        $validator  = Validator::make($request->all(), [
            ...
            'imagen' => 'required|max:1024|dimensions:max_width=1200,max_height=300'
        ]);
        if ($validator->fails()) {
    ...
    public function ActualizarImagenBanner(Request $request){
        ...
        $validator = Validator::make($request->all(), [
            'nombre_imagen_upd'  =>  'required',
            'estado_upd'  =>  'required',
            'imagen_upd' => 'max:1024|dimensions:max_width=1200,max_height=300'
        ]);
        if ($validator->fails()) {
            return Redirect::to($url . 'imagesBanner')->withErrors($validator)->withInput();
        } else {
    ...
    public function CrearImagenBannerMovil(Request $request){
        ...
        $validator  = Validator::make($request->all(), [
            ...
            'imagen' => 'required|max:1024|dimensions:max_width=710,max_height=200'
        ]);
        if ($validator->fails()) {
    ...
    public function ActualizarImagenBannerMovil(Request $request){
        ...
        $validator = Validator::make($request->all(), [
            'nombre_imagen_upd'  =>  'required',
            'estado_upd'  =>  'required',
            'imagen_upd' => 'max:1024|dimensions:max_width=710,max_height=200'
        ]);
        if ($validator->fails()) {
            return Redirect::to($url . 'imagesBannerM')->withErrors($validator)->withInput();
        } else {
    ...
    public function CrearImagenCarousel(Request $request){
        ...
        $validator  = Validator::make($request->all(), [
            ...
            'orden'  =>  'required',
            'imagen' => 'required|max:1024|dimensions:max_width=1110,max_height=300'
        ]);
        if ($validator->fails()) {
    ...
    public function ActualizarImagenCarousel(Request $request){
        ...
        $validator = Validator::make($request->all(), [
            ...
            'orden_upd'  =>  'required',
            'estado_upd'  =>  'required',
            'imagen_upd' => 'max:1024|dimensions:max_width=1110,max_height=300'
        ]);
        if ($validator->fails()) {
            return Redirect::to($url . 'imagesCarousel')->withErrors($validator)->withInput();
        } else {
    ...
    public function CrearImagenCarouselMovil(Request $request){
        ...
        $validator  = Validator::make($request->all(), [
            ...
            'orden'  =>  'required',
            'imagen' => 'required|max:1024|dimensions:max_width=700,max_height=250'
        ]);
        if ($validator->fails()) {
    ...
    public function ActualizarImagenCarouselMovil(Request $request){
        ...
        $validator = Validator::make($request->all(), [
            ...
            'orden_upd'  =>  'required',
            'estado_upd'  =>  'required',
            'imagen_upd' => 'max:1024|dimensions:max_width=700,max_height=250'
        ]);
        if ($validator->fails()) {
            return Redirect::to($url . 'imagesCarouselM')->withErrors($validator)->withInput();
        } else {
